...
export class User {
  ...
  @ApiProperty({description:"User email address",example:"joedeo@gmail.com"})
  @Column({ unique: true })
  email: string;
  ...
  @ApiProperty({description:"User shippingAddress",example:"091/a gandhi dham, India"})
  @Column()
  shippingAddress: string;

  @ApiProperty({description:"User billingAddress",example:"01/bb indore , India"})
  @Column()
